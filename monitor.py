...
def calculate_remaining_time(km):
    '''
    This function estimates the remaining flight time when given the kilometers that remain for
    this flight. The function assumes an average speed of 15 km per minute and rounds down when calculating minutes.
    It returns a tuple of hours and then minutes remaining.
    '''
